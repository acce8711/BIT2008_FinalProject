/* This commented-out section is the old version of the tables without the lastModified column
...
--New version of tables with lastModified column to keep track of the last time the tables were edited
